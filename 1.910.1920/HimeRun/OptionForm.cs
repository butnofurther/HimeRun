...
namespace HimeRun {
    public partial class OptionForm : Form {
        ...
        private void AddFetchingDirectory(object sender, EventArgs e) {
            ...
            if (folderDialog.Path == "" || folderDialog.Path == null) {
                return;
            }
            DBLinker.Execute($@"
        ...
        private void ChangeFileTypes(object sender, EventArgs e) {
            ...
            prompt.ShowDialog();
            if (prompt.ConfirmedMessage == null || prompt.ConfirmedMessage == "") {
                return;
            }
        ...
        private void InitConfigUI() {
            ...
            // language
            string language = GetFromDB("Language", "中文(简体)");
        ...
        private void ConfigConfirm(object sender, EventArgs e) {
            ...
            SetDB("Language", ComboBoxLanguage.Text);
            // reset the program
        ...
        private void VisitWebsite(object sender, EventArgs e) {
            Process.Start("https://github.com/butnofurther/HimeRun");
        }
    }
}
